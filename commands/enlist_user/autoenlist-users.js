...
module.exports = {
    ...
    async execute(client, message, guildName) {
        ...
        /** 
         * prevent other button messages occuring simultaneously 
         * not using preventmessageCollision because that function rewrites the last sent message to indicate an aborted command.
