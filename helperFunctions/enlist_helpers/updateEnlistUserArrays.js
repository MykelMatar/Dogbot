 ...
 * @param interaction
 * @param {array} enlistedUsers
 * @param {array} rejectedUsers
 * @param {array} enlistedUserIds
 * @param {array} rejectedUserIds
 */
async function updateEnlistUserArrays(interaction, enlistedUsers, rejectedUsers, enlistedUserIds, rejectedUserIds){
...
module.exports = updateEnlistUserArrays